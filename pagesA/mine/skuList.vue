	...
	<view class="content">
		<scroll-view scroll-y="true" height="100vh">
			...
			height: 100vh;">
				...
				<text style="width: 90%; font-size: 28rpx;color: #a6a6a6;margin-bottom: 15rpx;">*积分原价：1元=1积分，平台以此为基础进行折扣计算</text>
				...
				margin-top: 20rpx;">
					...
					<view style="display: flex;flex-direction: row;align-items: center;" @click="openPop">
						...
						<uni-icons type="right" size="40rpx" color="#f73939" style="margin-left: 15rpx;margin-right: 35rpx;"></uni-icons>
					</view>
				</view>
				<view class="line"></view>
				<view style="width: 100%;display: flex;flex-direction: row;
					...
					<view class="pop-item-bg">
						...
						margin-top: 35rpx;margin-bottom: 35rpx;">
							<view style="display: flex;flex-direction: row;align-items: center;">
								<view style="background: linear-gradient(177.22deg,#ffeb3b,#ffc300);border-radius: 10rpx;">
									<image src="../../static/f-vip2-black.png" style="width: 65rpx;height: 65rpx;margin: 20rpx;"></image>
								</view>
								<view style="display: flex;flex-direction: column;margin-left: 20rpx;">
									<text style="font-size: 30rpx;font-weight: bold;color: #000;">积分充值享5折优惠</text>
									<text style="font-size: 28rpx;color: #ff8d1a;margin-top: 20rpx;">当前订单共计78元，可减28.00元</text>
								</view>
							</view>
