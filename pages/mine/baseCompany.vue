<template>
	<view class="content">
		<!-- 企业类型 -->
		<picker :range="typeColumns" @change="confirmTypeChange" class="input-v">
			<input placeholder="选择企业类型" border="none" disabled disabledColor='#FFF' v-model="companyType"></input>
		</picker>

		<view class="input-v">
			<input placeholder="填写企业全称(与营业执照一致)" border="none" font-size="30rpx"></input>
		</view>
		<view class="input-v" @click="selectAddress">
			<input placeholder="请选择企业所在地" border="none" font-size="30rpx" disabled disabledColor='#FFF'
				v-model="cityStr"></input>
		</view>
		<view class="input-v">
			<input placeholder="输入企业详细地址" border="none" font-size="30rpx"></input>
		</view>
