<template>
	<view class="content">
		<cl-header backgroundColor="#00acdd" title="注册车数万维" defaultTextColor="#FFF"></cl-header>
		...
		<view style="width: 85%;margin-top: 55rpx;display: flex;flex-direction: column; align-items: center;">
			...
			<u-input placeholder="填写电子邮箱(选填)" font-size="28rpx" style="background-color: #FFF;border-radius: 20rpx;
			margin-top: 40rpx;width: 95%;padding: 20rpx;" border="none">
			</u-input>
			
			<u-input placeholder="填写公司名称(选填)" font-size="28rpx" style="background-color: #FFF;border-radius: 20rpx;
			margin-top: 40rpx;width: 95%;padding: 20rpx;" border="none">
			</u-input>
			
			<u-checkbox-group style="display: flex;flex-direction: row;align-items: center;font-size: 26rpx;margin-top: 35rpx;"
			...
			<u-button text="提交注册" class="btn" color="#FFF" @click="submit"></u-button>
		</view>
	</view>
</template>
